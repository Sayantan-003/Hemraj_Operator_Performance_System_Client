...
import AlphaSectionFilters from "./AlfaSectionFilters";
import {
  LineChart,
  Line,
  XAxis,
...
const AlphaSectionReport = () => {
  ...
  const [parameters, setParameters] = useState([
    ...
    { name: "Dry Basis Oil % in Gums", value: "15 %" },
  ...
  const chartTitles = ["Total Production", "Unit Used in Per Ton Production"];
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
            ...
            <div className="xl:col-span-2 space-y-8">
              ...
              {/* Unit Used in Per Ton Production Chart (Full Width) */}
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <div className="flex items-center space-x-2 mb-6">
                  <TrendingUp className="h-5 w-5 text-blue-600" />
                  <h3 className="text-lg font-semibold text-gray-900">
